...
describe('GET /todos:id', () => {
    ...
    it('Should Not return User1 todo doc for User2', (done) => {
      request(app)
    ...
    it('should return if todo is not found...', (done) => {
      request(app)
...
describe('DELETE /todos:id', () => {
  ...
  it('should NOT remove User1 todo document by User2', (done) => {
...
describe('PATCH /todos:id', () => {
  ...
  it('should NOT update user1 Todo by user2', (done) => {
    var hexId = todos[1]._id.toHexString();
    var text = "Modified First Todo";
    var completed = true;
    request(app)
